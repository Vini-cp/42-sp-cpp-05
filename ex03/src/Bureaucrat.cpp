...
void Bureaucrat::signForm( Form& prForm )
{
    try
    {
        prForm.beSigned( *this );
        std::cout << mName << " signed " << prForm.getName() << std::endl;
    }
    catch ( std::exception& e )
    {
        std::cout << mName << " couldn't sign " << prForm.getName() << " because " << e.what() << std::endl;
    }
}

//------------------------------------------------------------------------------

void Bureaucrat::executeForm( const Form& prForm )
{
    try
    {
        prForm.execute( *this );
        std::cout << mName << " executed " << prForm.getName() << std::endl;
    }
    catch ( std::exception& e )
    {
        std::cout << mName << " couldn't execute " << prForm.getName() << " because " << e.what() << std::endl;
    }
}
